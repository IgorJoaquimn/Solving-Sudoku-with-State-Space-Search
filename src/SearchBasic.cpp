...
State * Search_Base::search()
{
    ...
    while (true)
    {
        ...
        if (this->current_state->is_final()) break; // Termination occurs when we are in the final state
        ...
        if ((limited_search && (!(this->lim--)))) break;  //If this is the last iteration, terminates 
